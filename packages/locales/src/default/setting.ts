export default {
  ...
  'agentLunaTalk.bind': 'Bind',
  'agentLunaTalk.bound': 'Bound',
  'agentLunaTalk.current.desc':
    'The card this assistant edits. Its snapshot is loaded into every conversation, so the model never has to ask which card you mean.',
  'agentLunaTalk.current.empty': 'No role card bound yet. Pick one of your cards below.',
  'agentLunaTalk.current.title': 'Bound role card',
  'agentLunaTalk.list.empty': 'You have no role cards on LunaTalk yet.',
  'agentLunaTalk.list.title': 'My role cards',
  'agentLunaTalk.loadError': 'Could not load your role cards.',
  'agentLunaTalk.next': 'Next',
  'agentLunaTalk.notConnected': 'Sign in with LunaTalk to see your role cards.',
  'agentLunaTalk.prev': 'Previous',
  'agentLunaTalk.refresh': 'Refresh snapshot',
  'agentLunaTalk.syncedAt': 'Synced {{date}}',
  'agentLunaTalk.unbind': 'Unbind',
  'agentTab.graph': 'Graph Runtime',
  'agentTab.lunatalk': 'LunaTalk Role Card',
