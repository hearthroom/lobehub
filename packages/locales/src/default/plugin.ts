export default {
  ...
  'lunatalk.preview.expires': 'Preview link expires {{date}}',
  'lunatalk.preview.open': 'Open in new tab',
  'lunatalk.validation.clean': 'No warnings.',
  'lunatalk.validation.quality': 'Quality',
  'lunatalk.validation.suggestedFixes': 'Suggested fixes',
  'lunatalk.validation.tokenBudget': 'Estimated {{tokens}} tokens ({{chars}} characters)',
  'lunatalk.validation.warnings': 'Warnings',
